...
user in an INI file next to MASGAUPortable.exe called MASGAUPortable.ini.
...
copy AppNamePortable.ini from this directory to MASGAUPortable.ini next to
MASGAUPortable.exe. The options in the INI file are as follows:
