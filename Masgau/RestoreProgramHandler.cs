...
using System.IO;
using MASGAU.ArchiveHandlers;
using MASGAU.LocationHandlers;

namespace MASGAU.Restore
{
    public class RestoreProgramHandler: Core
    {
        ...
        private GameHandler game_data;

        public RestoreProgramHandler(RunWorkerCompletedEventHandler when_done, Interface new_interface, ArchiveHandler archive): base(when_done, new_interface) {
